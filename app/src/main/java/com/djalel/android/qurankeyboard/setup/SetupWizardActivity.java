...
package com.djalel.android.qurankeyboard.setup;
...
import com.djalel.android.qurankeyboard.compat.TextViewCompatUtils;
import com.djalel.android.qurankeyboard.compat.ViewCompatUtils;
import com.djalel.android.qurankeyboard.settings.ImePrefsActivity;
import com.djalel.android.qurankeyboard.utils.LeakGuardHandlerWrapper;
import com.djalel.android.qurankeyboard.utils.UncachedInputMethodManagerUtils;
...
public final class SetupWizardActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        TextViewCompatUtils.setCompoundDrawablesRelativeWithIntrinsicBounds(mActionFinish,
                ContextCompat.getDrawable(this, R.drawable.ic_setup_finish), null, null, null);
    ...
    static final class SetupStep implements View.OnClickListener {
        ...
        public SetupStep(final int stepNo, final String applicationName, final TextView bulletView,
            ...
            mActivatedColor = ContextCompat.getColor(stepView.getContext(), R.color.setup_text_action);
            mDeactivatedColor = ContextCompat.getColor(stepView.getContext(), R.color.setup_text_dark);
            ...
            if (actionIcon == 0) {
                ...
                TextViewCompatUtils.setCompoundDrawablesRelativeWithIntrinsicBounds(
                        mActionLabel, ContextCompat.getDrawable(stepView.getContext(), actionIcon), null, null, null);
            }
        }
